...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "ca5ef4d8-d112-41e6-9a0b-2773fb069a7c",
...
const _lazy_ufoetK = () => import('../routes/api/admin/tables.get.mjs');
const _lazy_80fAYx = () => import('../routes/api/auth/google-login.post.mjs');
const _lazy_K8UjoO = () => import('../routes/api/auth/google-register.post.mjs');
const _lazy_olh4q2 = () => import('../routes/api/login.post.mjs');
const _lazy_SUvq_T = () => import('../routes/api/register.post.mjs');
const _lazy_hq_tEJ = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/api/admin/tables', handler: _lazy_ufoetK, lazy: true, middleware: false, method: "get" },
  { route: '/api/auth/google-login', handler: _lazy_80fAYx, lazy: true, middleware: false, method: "post" },
  { route: '/api/auth/google-register', handler: _lazy_K8UjoO, lazy: true, middleware: false, method: "post" },
  { route: '/api/login', handler: _lazy_olh4q2, lazy: true, middleware: false, method: "post" },
  { route: '/api/register', handler: _lazy_SUvq_T, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_hq_tEJ, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_hq_tEJ, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch as $, useRuntimeConfig as a, getResponseStatus as b, defineRenderHandler as c, defineEventHandler as d, getQuery as e, createError$1 as f, getResponseStatusText as g, getRouteRules as h, hasProtocol as i, joinRelativeURL as j, joinURL as k, getContext as l, withTrailingSlash as m, withoutTrailingSlash as n, isScriptProtocol as o, parseQuery as p, createHooks as q, readBody as r, sanitizeStatusCode as s, toNodeListener as t, useNitroApp as u, executeAsync as v, withQuery as w, toRouteMatcher as x, createRouter$1 as y, defu as z };

...
const _lazy_Buv4LG = () => Promise.resolve().then(function () { return initDatabase_get$1; });
...
const _lazy_KRD4tq = () => Promise.resolve().then(function () { return setupAuthCredentials_post$1; });
const _lazy_p6xzuO = () => Promise.resolve().then(function () { return setupLicenseTracking_get$1; });
const _lazy_6lvt2E = () => Promise.resolve().then(function () { return setupTestUser_get; });
const _lazy_cw3Zcw = () => Promise.resolve().then(function () { return setupTransactionsTable_get$1; });
const _lazy_a103ey = () => Promise.resolve().then(function () { return setupWebhookLogging_get$1; });
...
const _lazy_YhZCz9 = () => Promise.resolve().then(function () { return testTransaction_post$1; });
const _lazy_ygNhL_ = () => Promise.resolve().then(function () { return testUsers_get$1; });
...
const _lazy_moYPxD = () => Promise.resolve().then(function () { return testData_get$1; });
const _lazy_SYEp7N = () => Promise.resolve().then(function () { return testProductsNixty_get$1; });
...
const handlers = [
  ...
  { route: '/api/admin/init-database', handler: _lazy_Buv4LG, lazy: true, middleware: false, method: "get" },
  ...
  { route: '/api/admin/setup-auth-credentials', handler: _lazy_KRD4tq, lazy: true, middleware: false, method: "post" },
  { route: '/api/admin/setup-license-tracking', handler: _lazy_p6xzuO, lazy: true, middleware: false, method: "get" },
  { route: '/api/admin/setup-test-user', handler: _lazy_6lvt2E, lazy: true, middleware: false, method: "get" },
  { route: '/api/admin/setup-transactions-table', handler: _lazy_cw3Zcw, lazy: true, middleware: false, method: "get" },
  { route: '/api/admin/setup-webhook-logging', handler: _lazy_a103ey, lazy: true, middleware: false, method: "get" },
  ...
  { route: '/api/admin/test-transaction', handler: _lazy_YhZCz9, lazy: true, middleware: false, method: "post" },
  { route: '/api/admin/test-users', handler: _lazy_ygNhL_, lazy: true, middleware: false, method: "get" },
  ...
  { route: '/api/test-data', handler: _lazy_moYPxD, lazy: true, middleware: false, method: "get" },
  { route: '/api/test-products-nixty', handler: _lazy_SYEp7N, lazy: true, middleware: false, method: "get" },
...
const initDatabase_get = defineEventHandler(async (event) => {
  try {
    ...
    if (schemaResult.length === 0) {
      ...
      await db.query("CREATE SCHEMA IF NOT EXISTS nixty");
    ...
    const [categoriesTableResult] = await db.query(`
      SELECT table_name FROM information_schema.tables 
    ...
    if (categoriesTableResult.length === 0) {
      ...
      const [categoriesColumnsResult] = await db.query(`
        SELECT column_name FROM information_schema.columns 
        WHERE table_schema = 'nixty' AND table_name = 'categories'
      `);
    ...
    const [productsTableResult] = await db.query(`
      SELECT table_name FROM information_schema.tables 
    ...
    if (productsTableResult.length === 0) {
      ...
      const [productsColumnsResult] = await db.query(`
        SELECT column_name FROM information_schema.columns 
        WHERE table_schema = 'nixty' AND table_name = 'products'
      `);
...
const initDatabase_get$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: initDatabase_get
}, Symbol.toStringTag, { value: 'Module' }));
...
const setupAuthCredentials_post = defineEventHandler(async (event) => {
  try {
    const user = await requireAuth(event);
    if (!user || user.account_type !== "admin") {
      throw createError({
...
const setupAuthCredentials_post$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: setupAuthCredentials_post
}, Symbol.toStringTag, { value: 'Module' }));

const setupLicenseTracking_get = defineEventHandler(async (event) => {
  try {
    const user = await requireAuth(event);
    if (!user || user.account_type !== "admin") {
      throw createError({
...
const setupLicenseTracking_get$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: setupLicenseTracking_get
}, Symbol.toStringTag, { value: 'Module' }));
  ...
  try {
    ...
    if (existingUser.length === 0) {
      const [userResult] = await db.execute(
        ...
        ["Test User", "testing@example.com", "$2b$10$dummyhash"]
        // dummy hash
      );
    ...
    if (existingTransaction.length === 0) {
      const [transactionResult] = await db.execute(
        `INSERT INTO transactions (user_id, order_id, amount, status, payment_type, created_at) 
         VALUES (?, ?, ?, ?, ?, NOW())`,
        [userId, `ORDER-TEST-${Date.now()}`, 5e4, "pending", "credit_card"]
      );
...
const setupTestUser_get = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: handler
}, Symbol.toStringTag, { value: 'Module' }));

const setupTransactionsTable_get = defineEventHandler(async (event) => {
  try {
...
const setupTransactionsTable_get$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: setupTransactionsTable_get
}, Symbol.toStringTag, { value: 'Module' }));

const setupWebhookLogging_get = defineEventHandler(async (event) => {
  try {
    const headers = getHeaders(event);
    const userId = headers["x-user-id"];
    const userEmail = headers["x-user-email"];
...
const setupWebhookLogging_get$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: setupWebhookLogging_get
}, Symbol.toStringTag, { value: 'Module' }));
...
const testTransaction_post = defineEventHandler(async (event) => {
  try {
    const body = await readBody(event);
...
const testTransaction_post$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: testTransaction_post
}, Symbol.toStringTag, { value: 'Module' }));
...
const testUsers_get = defineEventHandler(async (event) => {
  ...
  try {
    ...
    try {
      ...
      results.tableStructure = {
        ...
        editableColumns: columns.filter(
          (col) => !["id", "created_at"].includes(col.Field)
        ).map((col) => col.Field)
      };
    ...
    const commonIssues = [];
    if (!((_b = (_a = results.createTest) == null ? void 0 : _a.validatedData) == null ? void 0 : _b.password) || ((_d = (_c = results.createTest) == null ? void 0 : _c.validatedData) == null ? void 0 : _d.password) === "testpassword123") {
      commonIssues.push("Password hashing may not be implemented in validation");
    }
    const requiredFields = ((_g = (_f = (_e = results.tableStructure) == null ? void 0 : _e.columns) == null ? void 0 : _f.filter((col) => !col.nullable && !col.extra.includes("auto_increment"))) == null ? void 0 : _g.map((col) => col.name)) || [];
    results.analysis = {
      requiredFields,
      commonIssues,
      recommendations: [
...
const testUsers_get$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: testUsers_get
}, Symbol.toStringTag, { value: 'Module' }));
...
const testData_get = defineEventHandler(async (event) => {
  try {
...
const testData_get$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: testData_get
}, Symbol.toStringTag, { value: 'Module' }));

const testProductsNixty_get = defineEventHandler(async (event) => {
  var _a;
  try {
    ...
    return {
      ...
      total_products: ((_a = countResult[0]) == null ? void 0 : _a.total) || 0,
...
const testProductsNixty_get$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: testProductsNixty_get
}, Symbol.toStringTag, { value: 'Module' }));

import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import path from 'path';
...
export { sendLicenseEmail as a, sendMultipleLicenseEmail as s, testEmailConnection as t };

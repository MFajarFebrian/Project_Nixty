<template>
  <div class="payment-status-container">
    <div class="status-card error">
      ...
      <h1 class="status-title">Transaction Error</h1>
      <p class="status-message">
        An error occurred during your transaction. Please check your payment details and try again.
      </p>
...
console.log('Payment error page - Received query:', route.query)
</script>
